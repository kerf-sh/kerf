...
# ---------------------------------------------------------------------------
# Raimondi-Boyd fitted correlations
# Data from: Raimondi & Boyd 1958, full-journal (360°), L/D = 1.0
# We fit the published chart data as polynomial/rational approximations in ε.
# For other L/D ratios we apply the standard interpolation factor (see below).
# ---------------------------------------------------------------------------
