...
- bare 'geom.*' imports in migrated modules resolve correctly
- plugin package imports (kerf_cad_core.*) resolve from src/
"""
import sys
import os

_HERE = os.path.dirname(os.path.abspath(__file__))
_PLUGIN_ROOT = os.path.dirname(_HERE)        # e.g. packages/kerf-cad-core/
